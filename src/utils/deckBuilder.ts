...
const STARTERS: Record<ElementType, { id: string; name: string; hp: number; attacks: { name: string; damage: number; energyCost: number }[] }> = {
    ...
    psychic: { id: 'starter-psychic', name: 'Abra', hp: 40, attacks: [{ name: 'Teleport', damage: 0, energyCost: 1 }, { name: 'Psyshock', damage: 20, energyCost: 2 }] },
    fighting: { id: 'starter-fighting', name: 'Machop', hp: 60, attacks: [{ name: 'Low Kick', damage: 20, energyCost: 1 }, { name: 'Karate Chop', damage: 40, energyCost: 2 }] }
}
